...
export default function Home(props) {
  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center">
      <div className="absolute inset-0 w-full h-full overflow-hidden invisible md:visible">
        <svg
          id="firstSVG"
          viewBox="0 0 900 500"
          className="w-full"
      ...
      <div className="absolute inset-0 w-full h-full flex flex-col items-center mt-40 md:mt-0 md:justify-center px-4 text-center">
        <h1 className="text-6xl md:text-9xl font-bold">Horizon</h1>
        <h3 className="text-sm md:text-base text-gray-400 font-semibold">
